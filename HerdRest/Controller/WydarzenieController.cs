...
namespace HerdRest.Controller
{
    ...
    public class WydarzenieController : ControllerBase
    {
        ...
        public WydarzenieController(IWydarzenieRepository wydarzenieRepository)
        {
        ...
        [HttpGet("{lochaId}/wydarzeniaLochy")]
        public IActionResult GetWydarzeniaLochy(int lochaId)
        {
            throw new NotImplementedException();
        }

        [HttpGet("{miotId}/wydarzeniaMiotu")]
        public IActionResult GetWydarzeniaMiotu(int miotId)
        {
            throw new NotImplementedException();
        }
